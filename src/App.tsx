...
function App() {
  ...
  const [siteSettings, setSiteSettings] = useState<SiteSettings>({
    ...
    heroSubtitle_en: 'VIP Taxi Service in Bahrain',
    heroDescription: 'نقدم لك أرقى خدمات التوصيل واللوميزين في مملكة البحرين وجميع دول الخليج.',
    heroDescription_en: 'We provide you with the finest transportation and limousine services in the Kingdom of Bahrain and all GCC countries.',
    ...
    footerAbout_en: 'We specialize in providing family and luxury transportation services.',
