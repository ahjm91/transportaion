...
import { X, Wallet, Search, Loader2, MapPin, Calendar } from 'lucide-react';
...
export const PaymentModal = ({
  isOpen, onClose, siteSettings, lang, t
}: PaymentModalProps) => {
              ...
              {!paymentTrip ? (
                ...
                <div className="space-y-8">
                  ...
                  <button 
                    ...
                    className="w-full bg-[#25D366] text-white py-5 rounded-[2rem] font-black text-lg shadow-xl shadow-green-500/20 hover:bg-[#128C7E] transition-all flex items-center justify-center gap-3"
                  >
                    ...
                    {lang === 'ar' ? 'تأكيد الحجز عبر واتساب' : 'Confirm via WhatsApp'}
                  </button>
